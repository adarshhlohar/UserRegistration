...
class User implements IUser {
	...
	/*
	 * @Desc: In this function we can match the pattern and if the pattern matches
	 * it will set the name or it will gives the invalid name
	 * 
...
//		USe Case 2
	...
	/*
	 * @Desc: In this function we can match the pattern of email and if the pattern
	 * matches it will set the email or it will gives the invalid email
	 * 
	...
	/*
	 * @Desc: In this function we can validate the mobile number if Mobile Number is
	 * valid with country code it will set the mobile number or it will give the
	 * invalid msg
	 * 
	...
	/*
	 * @Desc: Here in this function we can set the function it can contaiin 8
	 * character with the first caps letter
	 * 
